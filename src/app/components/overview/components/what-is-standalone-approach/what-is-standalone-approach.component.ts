...
export class WhatIsStandaloneApproachComponent {
  ...
  constructor() {
    ...
    this.cardItems = [
      ...
      {
        title: 'What is the use of this approach in Angular?',
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'For promoting better organization of code, as they can be grouped based on their functionality or purpose.',
